...
from plone.workflowmanager.actionmanager import RuleAdapter, ActionManager
from urllib.parse import urlencode
from zope.i18nmessageid import MessageFactory
from plone.workflowmanager.utils import generateRuleName
    ...
    def __call__(self):
        ...
        if self.request.get("form.actions.add", False):
            ...
            if rule is None:
                ...
                r = Rule()
                r.title = "%s transition content rule" % (self.selected_transition.id)
                r.description = "This content rule was automatically created by the workflow manager to support actions on workflow transitions. If you want the behavior to work as expected, do not modify this outside of the workflow manager."
